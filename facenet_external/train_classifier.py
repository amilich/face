...
if __name__ == '__main__':
    ...
    # parser.add_argument('--use_tpu', action='store_true', dest='is_train', default=False,
    #                     help='Use TPU or not')
    # parser.add_argument('--tpu_name', type=str, action='store', dest='classifier_path',
    #                     help='TPU name')
    ...
    main(input_directory=args.input_dir, model_path=args.model_path, classifier_output_path=args.classifier_path,
         ...
         min_images_per_labels=args.min_images_per_class, split_ratio=args.split_ratio,
         # use_tpu=args.use_tpu, tpu_name=args.tpu_name,
